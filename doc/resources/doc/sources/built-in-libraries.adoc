...
+
Calls `yada.resources.file-resource/new-directory-resource` on the `io/file` of the `:path` of the options provided.
...
+
Calls `yada.resources.file-resource/new-file-resource` on the `io/file` of the `:path` of the options provided.
