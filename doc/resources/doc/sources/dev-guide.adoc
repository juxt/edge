...
On a ClojureScript project you should use a `cider-jack-in-clj&cljs` to `jack-in`.
When prompted, select `custom` as your REPL type.
For the form, enter `(cljs-repl)`.
