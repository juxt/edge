...
Edge is Free Software. Use Edge as the <<adaptation#,basis of your own Clojure web
project>>. Edge is ideal for websites, web APIs, microa-services and
more.
...
include::doc/explanation.adoc[leveloffset=+1]

include::doc/adaptation.adoc[leveloffset=+1]

include::doc/architecture.adoc[leveloffset=+1]
...
link:/sources/resources/config.edn[resources/config.edn]. This is a
standard EDN file containing tag literals which help configure the
system for multiple operating
environments. https://github.com/juxt/aero[Aero] is used for reading
...
integrant:: A preferred alternative and replacement for Stuart Sierra's https://github.com/stuartsierra/component[component] library, used to assemble components to form the overall Edge system. More details at <<integrant>>.
[.yada]#yada#:: A web library

[bibliography]
== References

- [[[integrant]]] https://github.com/weavejester/integrant by James Reeves.
